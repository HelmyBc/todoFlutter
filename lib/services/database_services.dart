...
import 'package:todo/services/globals.dart';
...
class DatabaseServices {
  ...
  static Future<http.Response> toggleTask(int id) async {
    var url = Uri.parse(baseURL + '/toggle/$id');
  ...
  //TODO
  static Future<http.Response> updateTask(Task task, String t) async {
    Map data = {
      "title": t,
    };
    var body = json.encode(data);
